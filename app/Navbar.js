...
const NavBar = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 w-full h-20 p-1.5 shadow-lg bg-white md:h-16">
      <div className="flex justify-between items-center h-full px-4 md:px-8">
        <div className="flex items-center space-x-2 w-1/4 font-medium text-lg md:w-1/5 lg:w-1/5">
          <Link legacyBehavior href="/restaurants">
            <a>
              <Image
                className="transition-transform duration-800 hover:scale-125"
          ...
          <div className="flex items-center space-x-2 w-1/5 h-full">
            ...
            <span className="hidden md:inline-block">
              <Link legacyBehavior href="/carts">
                <a className="text-black no-underline">Carts</a>
              </Link>
            </span>
          </div>
        </div>
